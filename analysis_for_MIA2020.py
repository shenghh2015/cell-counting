...
def cell_count_evaluation():
	...
	results_root_folder = os.path.expanduser('/shared/planck/Cellcounting/turing/dl-cells/dlct-framework/results/MIA2018_v3_6.6-7.6')  ## Jun 27.2019
	result_folders = []
...
# 		est_for_methods.append(np.concatenate(est_pool, axis = 0))
	...
	table_dic['MRESTD'] = mre_std_for_methods
	...
	table_dic['C-MRE'] = crossmre_for_methods
	table_dic['C-MRESTD'] = crossmre_std_for_methods
	file_basename = 'MAE_STD_MRE_SSIM_MSE_RUN_MCE_STDMCE_CMRE_CMRESTD'
